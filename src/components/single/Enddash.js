          ...
          <div className="content">
            <div className="block three-col">
              ...
              <section className="one-col">
                <p>EndDash is a two-way-binding javascript templating framework built on top of semantic HTML. It was developed by the engineers at <Link to="/amicus">Amicus</Link> during the time I was at the company.</p>
              </section>
