          ...
          <div className="content">
            <div className="block three-col">
              ...
              <section className="one-col">
                ...
                <figure>
                  <ProgressiveImage src="media/amicus/interface/fullSite.jpg" placeholder="placeholder/amicus/interface/fullSite.jpg">
                    {(src) => <img src={src} alt=""/>}
                  </ProgressiveImage>
              ...
              <section className="two-col">
                ...
                <figure>
                  ...
                  <figcaption>Postcard tool interface sketch</figcaption>
                </figure>
