        ...
        <div className="wrapper">
          ...
          <div className="content">
            <div className="block three-col">
              <h1>More projects</h1>
              <span><h3>Quotidian Ventures</h3></span>
              <section className="two-col">
                <figure>
                  <ProgressiveImage src="media/quotidian/page.jpg" placeholder="placeholder/quotidian/page.jpg">
                    {(src) => <img src={src} alt=""/>}
                  </ProgressiveImage>
                  <figcaption>Quotidian Ventures needed a no-frills website to display their portfolio.</figcaption>
                </figure>
              </section>
              <section className="one-col">
                <figure>
                  <ProgressiveImage src="media/quotidian/companies.jpg" placeholder="placeholder/quotidian/companies.jpg">
                    {(src) => <img src={src} alt=""/>}
                  </ProgressiveImage>
                  <figcaption>The portfolio displays each company proudly with large logos.</figcaption>
                </figure>
              </section>
              <br/>
              <br/>
              <br/>
              <section className="one-col break">
                <figure>
                  <ProgressiveImage src="media/quotidian/about.jpg" placeholder="placeholder/quotidian/about.jpg">
                    {(src) => <img src={src} alt=""/>}
                  </ProgressiveImage>
                  <figcaption>Sparse colors and direct messaging build a results-first brand.</figcaption>
                </figure>
              </section>
              <section className="two-col">
                <p>Quotidian Ventures is an early stage investment fund that focuses on businesses with a strategic advantage in their respective industries. They needed a portfolio website that provided an overview with contact information, without removing the focus from their brand and portfolio.</p>
